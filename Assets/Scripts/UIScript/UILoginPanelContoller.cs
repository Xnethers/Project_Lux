...
namespace UITween
{
    public class UILoginPanelContoller : UIManager
    {
        ...
        void Start()
        {
            LoginPanel.sizeDelta = Vector2.one;
        ...
        public void OpenLoginPanel()//登入介面展開
        {
            ...
            Tweener scale1 = LoginPanel.DOSizeDelta(new Vector2(StretchSize.x, 10), StretchDuration).Pause();
        ...
        {
            Sequence mySequence = DOTween.Sequence();
            Tweener scale1 = LoginPanel.DOSizeDelta(new Vector2(LoginPanel.sizeDelta.x, 10), StretchDuration).Pause();

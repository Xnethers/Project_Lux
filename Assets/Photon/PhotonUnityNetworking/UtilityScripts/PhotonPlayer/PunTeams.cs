...
namespace Photon.Pun.UtilityScripts
{
    ...
    public static class TeamExtensions
    {
        ...
        public static PunTeams.Team GetOtherTeam(this Player player)
        {
            object teamId;
            if (player.CustomProperties.TryGetValue(PunTeams.TeamPlayerProp, out teamId))
            {
                if ((PunTeams.Team)teamId == PunTeams.Team.red)
                { return (PunTeams.Team)PunTeams.Team.blue; }
                else
                { return (PunTeams.Team)PunTeams.Team.red; }
            }
